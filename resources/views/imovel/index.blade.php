...
<div id="container-page" class="interna2">
    ...
    <div class="container">
        ...
        <div id="tit-qtd-imoveis">
            <h6>Apartamento de 4 quartos, 112 m�</h6>
            <span>
                R$850.000,00<br>
            </span>
        </div>
        ...
        <div id="container-imovel">
            ...
            <div id="left-imovel">
                ...
                <div id="sobre-imovel">
                    <h5>Sobre o Apartamento</h5>
                    <p>
                        Apartamento com excelente localiza��o no centro da cidade, contendo: varanda, banheiro e �rea de servi�o independente, 4 quartos - sendo 1 su�te, 1 banheiro social, cozinha acoplada com copa e 2 vagas de garagem.<br><br>

                        Infraestrutura: portaria com porteiro f�sico 24h, elevador, acad�mia, aquecimento solar que gera economia na conta de luz, interfone, sistema de seguran�a com c�meras, guaria, port�o eletr�nico e g�s canalizado.<br><br>

                        *Os valores do im�vel podem sofrer altera��o sem aviso pr�vio.<br>
                        *Verifique a disponibilidade do im�vel.
                    </p>
                </div>
                ...
                <div id="localizacao-mapa">
                    <h5>Localiza��o</h5>
                    <div id="mapa">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d6276.0413945484415!2d-46.61001203864798!3d-20.720108638775734!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1spt-BR!2sbr!4v1659306563493!5m2!1spt-BR!2sbr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            ...
            <div id="right-imovel">
                <div id="right-imovel-int">
                    ...
                    <div id="novas-condicoes">
                        <h6>Novas condi��es para que voc� conquiste seu im�vel agora mesmo</h6>
                        <span>N�o perca essa oportunidade</span>
                        <p>
                            de R$850.000,00<br>
                            <strong>por R$800.000,00</strong>
                        </p>
                    </div>
