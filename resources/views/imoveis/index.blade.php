...
<div id="container-page" class="interna">
    ...
    <div class="container">
        ...
        <div id="tit-qtd-imoveis">
            <h6>117 im�veis � venda em Passos</h6>
        </div>
                ...
                <div id="selects-filtro-inicial">
                    ...
                    <fieldset>
                        ...
                        <div class="select-filtro-inicial" id="filtro-bairro">
                            ...
                            <input type="hidden" id="tipo-bairro">

                            <div class="box-select-filtro">
                                <div class="slider-filtros" id="slider-filtros-3">
                                    <ul>
                                        <li><a data-value="1" data-tipo="Bairro 1">Bairro 1</a></li>
                                        <li><a data-value="2" data-tipo="Bairro 2">Bairro 2</a></li>
                                        <li><a data-value="3" data-tipo="Bairro 3">Bairro 3</a></li>
                                        <li><a data-value="4" data-tipo="Bairro 4">Bairro 4</a></li>
                                        <li><a data-value="5" data-tipo="Bairro 5">Bairro 5</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <fieldset>
                        <label>Selecione um tipo de im�vel</label>
                        <div class="select-filtro-inicial" id="filtro-tipo">
                            ...
                            <input type="hidden" id="tipo-imovel">

                            <div class="box-select-filtro">
                                <div class="slider-filtros" id="slider-filtros-2">
                                    <ul>
                                        <li><a data-value="1" data-tipo="Apartamento">Apartamento</a></li>
                                        <li><a data-value="2" data-tipo="Casa">Casa</a></li>
                                        <li><a data-value="3" data-tipo="Comercial">Comercial</a></li>
                                        <li><a data-value="4" data-tipo="Terreno">Terreno</a></li>
                                        <li><a data-value="5" data-tipo="Rural">Rural</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="dual-cp">
                        <fieldset>
                            <label>�rea (min)</label>
                            <input type="text" id="area_min" name="area_min">
                        </fieldset>

                        <fieldset>
                            <label>�rea (m�x)</label>
                            <input type="text" id="area_max" name="area_max">
                        </fieldset>
                    </div>
                    ...
                    <fieldset>
                        <label>Quartos</label>
                        <div class="variacoes">
                            <input type="hidden" id="qtd_quarto">
                            <a data-value="1">1+</a>
                            <a data-value="2">2+</a>
                            <a data-value="3">3+</a>
                            <a data-value="4">4+</a>
                    ...
                    <fieldset>
                        ...
                        <div class="variacoes">
                            <input type="hidden" id="qtd_banheiro">
                            <a data-value="1">1+</a>
                            <a data-value="2">2+</a>
                            <a data-value="3">3+</a>
                            <a data-value="4">4+</a>
                    ...
                    <fieldset>
                        ...
                        <div class="variacoes">
                            <input type="hidden" id="qtd_garagem">
                            <a data-value="1">1+</a>
                            <a data-value="2">2+</a>
                            <a data-value="3">3+</a>
                            <a data-value="4">4+</a>
                    ...
                    <fieldset>
                        ...
                        <input type="text" id="codigo" name="codigo" placeholder="Buscar por c�digo">
                    </fieldset>
        ...
        <div id="right-imoveis">
            ...
            <div id="abas-filtro">
                ...
                <a class="ativo">Comprar</a>
                <a>Alugar</a>
            </div>

            <div id="filtro-ordenar">
                <h6>
                    Ordenar por: <strong id="ordenar">Relev�ncia</strong>
                    <i>
                        <svg id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 451.85 257.57"><path d="M225.92,354.71a31.59,31.59,0,0,1-22.37-9.27L9.27,151.16A31.64,31.64,0,0,1,54,106.41l171.9,171.91L397.83,106.41a31.64,31.64,0,0,1,44.74,44.75L248.29,345.45A31.54,31.54,0,0,1,225.92,354.71Z" transform="translate(0 -97.14)"/></svg>
                    </i>
                </h6>
                <ul>
                    <li><a data-value="1">Menor pre�o</a></li>
                    <li><a data-value="2">Maior pre�o</a></li>
                    <li><a data-value="3">Menor �rea</a></li>
                    <li><a data-value="4">Maior �rea</a></li>
                    <li><a data-value="5">Mais recente</a></li>
                </ul>
            ...
            <div id="list-imoveis">
                ...
                <div class="box-imovel">
                    ...
                    <div class="container-slider-imovel">
                        ...
                        <div class="slider-imovel" id="slider-imovel-1">
        
                            <div class="swiper-wrapper">
        
                                <div class="swiper-slide">
        
                                    <a><img src="imgs/img15.jpg" alt=""></a>
                        ...
                        <div class="pager-slider-imovel" id="pager-slider-imovel-1">
                        </div>

                        <p>R$850.000,00</p>
        
                        <script>
                            const swiperImovel1 = new Swiper('#slider-imovel-1', {
                                slidesPerView: 1,
                                spaceBetween: 2,
                                freeMode: true,
                                ...
                                loop: true,
                                navigation: {
                                    nextEl: '#next-imovel-1',
                                    prevEl: '#prev-imovel-1',
                                },
                                pagination: {
                                    el: '#pager-slider-imovel-1',
                                    clickable: true
                                }
                            });
                        </script>
                    ...
                    <div class="info-list-imovel">
                        ...
                        <small>C�digo do im�vel: 00000</small>
                        <h6>Descri��o</h6>
                        <ul>
                            <li>
                                <figure>
                ...
                <div class="box-imovel">
                    ...
                    <div class="container-slider-imovel">
                        ...
                        <div class="slider-imovel" id="slider-imovel-2">
                        ...
                        <div class="pager-slider-imovel" id="pager-slider-imovel-2">
                        </div>

                        <p>R$850.000,00</p>
        
                        <script>
                            const swiperImovel2 = new Swiper('#slider-imovel-2', {
                                slidesPerView: 1,
                                spaceBetween: 2,
                                paginationClickable: true,
                                loop: true,
                                navigation: {
                                    nextEl: '#next-imovel-2',
                                    prevEl: '#prev-imovel-2',
                                },
                                pagination: {
                                    el: '#pager-slider-imovel-2',
                                    clickable: true
                                }
                            });
                        </script>
                ...
                <div class="box-imovel">
                    ...
                    <div class="container-slider-imovel">
                        ...
                        <div class="slider-imovel" id="slider-imovel-3">
                        ...
                        <div class="pager-slider-imovel" id="pager-slider-imovel-3">
                        </div>

                        <p>R$850.000,00</p>

                        <script>
                            const swiperImovel3 = new Swiper('#slider-imovel-3', {
                                slidesPerView: 1,
                                spaceBetween: 2,
                                paginationClickable: true,
                                loop: true,
                                navigation: {
                                    nextEl: '#next-imovel-3',
                                    prevEl: '#prev-imovel-3',
                                },
                                pagination: {
                                    el: '#pager-slider-imovel-3',
                                    clickable: true
                                }
                            });
                        </script>
